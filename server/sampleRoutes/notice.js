...
import notice from '../sampleModels/notice';
...
router.post('/', (req, res) => {
  ...
  res.json({ 
    result: notice.post(req.body.classID, req.body.title, req.body.content)
  });
...
router.delete('/:id', (req, res) => {
  ...
  res.json({ 
    result: notice.destroy(noticeID)
  });
